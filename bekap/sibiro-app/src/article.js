  ...
  render() {
    ...
    return (
      ...
      <div className="cart" id="kitchen">
        ...
        <strong style={{padding: "3%", background: "rgba(255, 255, 255, 0.3)", borderRadius: "10px", fontSize: "14px", marginTop: "30%", marginBottom: "15%"}}>Позвонить: <a href="tel:+79528807647" style={{color:"maroon"}}>+7 952 880 76 47</a> </strong>
        </div>
      </div>
      <div className="cart">
